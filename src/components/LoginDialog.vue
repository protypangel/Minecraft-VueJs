...
<v-dialog max-width="600px" v-model="loginDialog">
        ...
        <template v-slot:activator="{on}">
            <v-btn class="light-blue accent-3"  v-on="on">Connection</v-btn>
        </template>
        <v-card>
          <v-toolbar color="light-blue accent-3 mb-5">
          ...
          <v-form class="px-3 ml-3 py-3">
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="light-blue accent-3" class=" white--text px-4 mb-1" @click="validateBtnClicked(infos)">LOGIN</v-btn>
            </v-card-actions>
          </v-form>
        </v-card>
